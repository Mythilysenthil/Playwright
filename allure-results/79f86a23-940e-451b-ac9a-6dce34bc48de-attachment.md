...
Locator: locator('iframe[name="firstFr"]').contentFrame().locator('.text-sm font-semibold text-center')
...
Call log:
  ...
  - waiting for locator('iframe[name="firstFr"]').contentFrame().locator('.text-sm font-semibold text-center')
...
> 12 |     await expect(frame.locator(".text-sm font-semibold text-center")).toContainText("You have entered Mythily S")
     |                                                                       ^ Error: expect(locator).toContainText(expected) failed
  13 | })
```