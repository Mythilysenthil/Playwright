...
Locator: locator('iframe[name="firstFr"]').contentFrame().locator('p.text-sm.font-semibol.text-center')
...
Call log:
  ...
  - waiting for locator('iframe[name="firstFr"]').contentFrame().locator('p.text-sm.font-semibol.text-center')
...
> 12 |     await expect(frame.locator("p.text-sm.font-semibol.text-center")).toContainText("You have entered Mythily S")
     |                                                                       ^ Error: expect(locator).toContainText(expected) failed
  13 | })
```