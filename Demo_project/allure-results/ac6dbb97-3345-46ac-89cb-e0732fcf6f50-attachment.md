...
Locator: getByAltText('//img[@alt=\'Website for automation practice\']')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByAltText('//img[@alt=\'Website for automation practice\']')
...
> 5  |   await expect(page.getByAltText("//img[@alt='Website for automation practice']")).toBeVisible();
     |                                                                                    ^ Error: expect(locator).toBeVisible() failed
